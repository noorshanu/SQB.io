    ...
    NioApp.Chart.ChartJs = function() {
        NioApp.Chart.ChartJs.Doughnut = function(_canvas, _titles, _colors, _amounts, _canvas_border, _canvas_cutout) {
            if ($('#' + _canvas).length) {
                ...
                var doughnut_chart = new Chart(_canvas_el, { type: 'doughnut', data: { labels: _titles, datasets: [{ label: "949", lineTension: 0, backgroundColor: _colors, borderColor: _canvas_border, borderWidth: 2, hoverBorderColor: _canvas_border, data: _amounts, }] }, options: { legend: { display: !1, labels: { boxWidth: 10, fontColor: '#000' } }, rotation: -2, cutoutPercentage: _canvas_cutout, responsive: !0, maintainAspectRatio: !1, tooltips: { callbacks: { title: function(tooltipItem, data) { return data.labels[tooltipItem[0].index] }, label: function(tooltipItem, data) { return data.datasets[0].data[tooltipItem.index] + ' %' } }, backgroundColor: '#eff6ff', titleFontSize: 13, titleFontColor: '#6783b8', titleMarginBottom: 10, bodyFontColor: '#9eaecf', bodyFontSize: 14, bodySpacing: 4, yPadding: 15, xPadding: 15, footerMarginTop: 5, displayColors: !1 } } });
                $win.on('resize', function() { doughnut_chart.resize() })
            }
        }
        NioApp.Chart.ChartJs.Doughnut2 = function(_canvas, _titles, _colors, _amounts, _canvas_border, _canvas_cutout) {
            if ($('#' + _canvas).length) {
                ...
                var doughnut_chart = new Chart(_canvas_el, {
                    type: 'doughnut',
                    data: { labels: _titles, datasets: [{ label: "949", lineTension: 0, backgroundColor: _colors, borderColor: _canvas_border, borderWidth: 3, hoverBorderColor: _canvas_border, data: _amounts, }] },
                    options: {
                        ...
                        hover: {
                            onHover: function(e, i) {
                                ...
                                } else { $('[data-canvas="' + _self_can + '"] li').removeClass('active') }
                            },
                        }
                    }
                });
        ...
        NioApp.Chart.ChartJs.Pie = function(_canvas, _label, _title, _colors, _colors_hover, _amounts, _canvas_border, _canvas_cutout) {
            if ($('#' + _canvas).length) {
                var _canvas_el = document.getElementById(_canvas).getContext("2d");
                var data_set = { labels: _label, titles: _title, datasets: [{ label: "949", lineTension: 0, backgroundColor: _colors, hoverBackgroundColor: _colors_hover, borderColor: _canvas_border, borderWidth: 2, hoverBorderColor: _canvas_border, data: _amounts, animationDuration: 400, }] };
                var options_set = {
                    legend: !1,
                    cutoutPercentage: 0,
                    responsive: !0,
                ...
                $win.on('resize', function() { pie_chart.resize() })
            }
        }
        if ($chart.length > 0) {
            $chart.each(function() {
        ...
        if ($chart_s1.length > 0) {
            $chart_s1.each(function() {
                ...
                if (typeof _canvas !== 'undefined' && _canvas !== '') {
                    ...
                    for (var i = 0; i < $chart_data.length + 1; i++) { $chart_data.eq(i - 1).addClass('chart-index-' + i) }
